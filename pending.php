                                ...
                                <div class="as-accessories-filter-tile column large-6 small-3">
                                    ...
                                    <button class="as-filter-button" aria-expanded="true" aria-controls="as-search-filters" type="button">
                                        <h2 class=" as-filter-button-text">
                                            Pendiente. Te avisaremos cuando se pueda procesar tu pago.
                                        </h2>
                                    </button>
                            ...
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    <div class="as-producttile-titlepricewraper" style="min-height: 128px;">
                                      ...
                                      <h3 >Estado:<? echo $_GET['collection_status'];?></h3>
                                      <h3 >Id Pago: <? echo $_GET['collection_id'];?></h3>  
                                      <h3 >Forma de Pago: <? echo $_GET['payment_type'];?></h3>  
                                      <h3>Preference: <? echo $_GET['preference_id'];?></h3>
                                      <h3>Email Reference: <? echo $_GET['external_reference'];?></h3>
                                  </div>
                               </div>
                              </div>
                        </div>
